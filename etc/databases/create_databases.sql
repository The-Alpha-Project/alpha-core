...
CREATE DATABASE IF NOT EXISTS `alpha_auth` DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON `alpha_auth` . * TO 'alphapython'@'localhost' WITH GRANT OPTION;
