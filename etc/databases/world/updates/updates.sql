...
begin not atomic
    ...
    if (select count(*) from applied_updates where id='300820231') = 0 then
        ...
        INSERT INTO creature_movement VALUES (400102, 1, -9275.37109375, -2258.993408203125, 65.47622680664062, 4.620493412017822, 15000, 0, 0);
        ...
        INSERT INTO creature_movement VALUES (400099, 1, -9272.34765625, -2268.39453125, 66.55569458007812, 4.672332763671875, 30000, 0, 0);
