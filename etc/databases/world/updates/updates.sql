...
begin not atomic
    ...
    if (select count(*) from `applied_updates` where id='220620231') = 0 then
        ...
        -- CREATE spawns_creatures 4299
        INSERT INTO spawns_creatures VALUES (NULL, 4299, 0, 0, 0, 44, 432.3927307128906, -107.138671875, 30.828096389770508, 1.5989586114883423, 18000, 18000, 0, 100, 3, 1, 0, 0, 0);
