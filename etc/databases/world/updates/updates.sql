...
begin not atomic
    ...
    IF (SELECT COUNT(*) FROM `applied_updates` WHERE id='140920231') = 0 THEN
        ...
        UPDATE `quest_template` SET `RewOrReqMoney` = 4400,  `parse_timestamp`='2004-05-18' WHERE `entry` = 427;
        UPDATE `quest_template` SET `RewOrReqMoney` = 600,  `parse_timestamp`='2004-05-18' WHERE `entry` = 443;
        UPDATE `quest_template` SET `RewOrReqMoney` = 4400,  `parse_timestamp`='2004-05-18' WHERE `entry` = 445;
        ...
        UPDATE `quest_template` SET `RewOrReqMoney` = 1000,  `parse_timestamp`='2004-05-18' WHERE `entry` = 590;
