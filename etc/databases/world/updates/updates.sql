...
begin not atomic
    ...
    IF (SELECT COUNT(*) FROM `applied_updates` WHERE id='140920231') = 0 THEN
        ...
        UPDATE `quest_template` SET `Objectives` = 'Bring 12 Salty Scorpid Venoms to Fizzle Brassbolts in the Shimmering Flats.', `ReqItemCount1` = 10,  `parse_timestamp`='2004-05-20' WHERE `entry` = 1104;
        UPDATE `quest_template` SET `Details` = 'Heh heh, with all the races they\'re running here, it\'s no suprise that a few mishaps happen along the way.  If you look around the Shimmering Flats then you\'ll see evidence of past crashes -- scraps of rocket car parts are littered everywhere!$B$BAnd those parts are worth money to the gnomes and goblins.  They\'re always looking for more contraptions to slap onto their cars.$B$BSo go out and get me parts.  Bring me a heap and I\'ll pay you well.',  `parse_timestamp`='2004-05-18' WHERE `entry` = 1110;
        UPDATE `quest_template` SET `Objectives` = 'Bring the Delicate Car Parts to Fizzle Brassbolts.',  `parse_timestamp`='2004-05-13' WHERE `entry` = 1114;
        ...
        UPDATE `quest_template` SET `PrevQuestId` = 1339,  `parse_timestamp`='2004-06-01' WHERE `entry` = 1338;
        ...
        UPDATE `quest_template` SET `Details` = 'Magistrate Solomon\'s note pains me to read.  But it is obvious he knows not the war which is waged in Westfall or else he would know better than to expect aid from the Militia.  If Stormwind had not deserted us as well, we would not have the need for the Militia.$B$BTake this response to your Master in Redridge, $r.  And let him know that my heart is heavy with the loss of good men.',  `parse_timestamp`='2004-06-01' WHERE `entry` = 144;
        UPDATE `quest_template` SET `RewItemId1` = 1217,  `parse_timestamp`='2004-06-01' WHERE `entry` = 150;
        UPDATE `quest_template` SET `Objectives` = 'Kill 5 Tidehunters, 10 Warriors, and 15 Coastrunners and return to Captain Grayson at the Westfall Lighthouse.', `Details` = 'You probably noticed all of the shipwrecks along the coast.  The Great Sea is treacherous indeed.  The coast of Westfall needs to be kept clear, so that if sailors find their way to our beaches, they are safe.  The Murlocs are trouble though.$B$BKill 5 Tidehunters, 10 Warriors, and 15 Coastrunners and I will see to it that you are rewarded.', `ReqCreatureOrGOCount1` = 15, `ReqCreatureOrGOCount2` = 10, `ReqCreatureOrGOCount3` = 5, `ReqCreatureOrGOId4` = 0, `ReqCreatureOrGOCount4` = 0,  `parse_timestamp`='2004-06-01' WHERE `entry` = 152;
        UPDATE `quest_template` SET `Objectives` = 'Bring the Ghost Hair Thread to Abercrombie, in his shack north of the Raven Hill Cemetary.',  `parse_timestamp`='2004-06-01' WHERE `entry` = 157;
        UPDATE `quest_template` SET `Objectives` = 'Bring the Zombie Juice to Abercrombie at this shack.',  `parse_timestamp`='2004-06-01' WHERE `entry` = 159;
        ...
        UPDATE `quest_template` SET `RewItemId1` = 5244, `RewItemCount1` = 1,  `parse_timestamp`='2004-06-01' WHERE `entry` = 222;
        ...
        UPDATE `quest_template` SET `Details` = 'I would pit you against the power of Morbent Fel, but I will not permit you to be rent by that vile fiend without first knowing your strength.$B$BYou have already proven your bravey to me, but if you truly wish to face the Necromancer, then you must now prove your skill against his minions.',  `parse_timestamp`='2004-06-01' WHERE `entry` = 323;
        ...
        UPDATE `quest_template` SET `Details` = '',  `parse_timestamp`='2004-05-18' WHERE `entry` = 478;
        ...
        UPDATE `quest_template` SET `Details` = 'Stand at attention while addressing me, $r.$B$BI am under direct command of Varimathras.  We are to quell the human infestation until our apothecaries can develop the new plague.$B$BOur information leads us to believe that the town of Hillsbrad is vulnerable to attack.  Your first assignment is aimed at disrupting their food supply and infrastructure.$B$BTravel west.  Raid the northernmost farms of Hillsbrad Fields.  Make sure that the landowners, Farmer Ray and Farmer Getz, are executed as well.',  `parse_timestamp`='2004-05-20' WHERE `entry` = 527;
        UPDATE `quest_template` SET `RewItemId1` = 1217, `RewItemCount1` = 1,  `parse_timestamp`='2004-06-01' WHERE `entry` = 531;
        UPDATE `quest_template` SET `Details` = 'At last we begin to hear word and rumor, find evidence of Gol\'dir\'s whereabouts. The humans have been moving him around, but we are narrowing down our search and focusing on the large Syndicate camp just north of here.$B$BGo there, $n, and bring back whatever information you can put your hands on.',  `parse_timestamp`='2004-05-18' WHERE `entry` = 533;
        ...
        UPDATE `quest_template` SET `Details` = 'If there\'s one thing you\'ll learn about Southshore it\'s that we have some of the best cuisine north of Stormwind!$B$BTake my secret recipe for Turtle Bisque, for example.  I\'ve known folks to travel as far as Darkshire just to enjoy a bowl.  Speaking of which, I haven\'t been able to make any lately.  I used to head up past Dalaran to Lake Lordamere myself to hunt Snapjaws but it\'s just too dangerous now. If you bring me some Turtle Meat from the Snapjaws up north and Soothing Spices, I\'ll whip some up!',  `parse_timestamp`='2004-06-01' WHERE `entry` = 555;
        UPDATE `quest_template` SET `Details` = 'A notable talent of the wizards of Dalaran is their familiarity with elementals: powerful creatures from other dimensions.  The wizards use magical stone tokens as a means to control these elementals.  Magus Voidglare would like some of these tokens to study.$B$BEnter the territories of the Dalaran wizards and gather Worn Stone Tokens, then bring them to me.$B$BYou might find the tokens on any citizen of Dalaran in the area, but I suggest hunting at the internment camp.  It\'s safer than Dalaran itself.',  `parse_timestamp`='2004-05-20' WHERE `entry` = 556;
        ...
        UPDATE `quest_template` SET `Objectives` = 'Bring Root Samples to Mebok Mizzyrix in Ratchet.',  `parse_timestamp`='2004-06-01' WHERE `entry` = 866;
