...
begin not atomic
    ...
    if (select count(*) from `applied_updates` where id='260620232') = 0 then
        ...
        -- CREATE spawns_creatures 3989
        INSERT INTO spawns_creatures VALUES (NULL, 3989, 0, 0, 0, 1, -26.202068328857422, -701.9427490234375, -13.734065055847168, 2.5817857931542676e-06, 300, 300, 3, 100, 0, 1, 0, 0, 0);
