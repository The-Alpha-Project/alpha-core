...
class GameobjectTemplate(Base):
    ...
    data11 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data12 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data13 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data14 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data15 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data16 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data17 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data18 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data19 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data20 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data21 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data22 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
    data23 = Column(INTEGER(10), nullable=False, server_default=text("'0'"))
