...
class CharacterSocial(Base):
    ...
    ignore = Column(TINYINT(1), primary_key=True, nullable=False, index=True, server_default=text("0"), comment='Whether player is a friend(0) or ignore(1)')
...
class RealmList(Base):
    ...
    public_proxy_address = Column(String(15), nullable=False, server_default="0.0.0.0")
    ...
    public_realm_address = Column(String(15), nullable=False, server_default="0.0.0.0")
