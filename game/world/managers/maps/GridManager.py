    ...
    def update_object(self, world_object, has_changes=False, has_inventory_changes=False):
        ...
        if has_changes or has_inventory_changes:
            ...
            if has_changes:
                ...
                update_data = world_object.update_packet_factory.generate_update_data(flush_current=True, ignore_timestamps=True)
            ...
            if has_inventory_changes:
                world_object.inventory.reset_fields_older_than(time.time(), ignore_timestamps=True)
