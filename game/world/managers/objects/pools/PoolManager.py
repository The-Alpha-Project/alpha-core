...
class PoolManager:
    ...
    def add_pool(self, spawn, pool, pool_template, master_pool_template=None):
        ...
        if master_pool_template:
            master_pool = self.get_or_create_pool(master_pool_template.pool_entry, 0, master_pool_template.description,
    ...
    def get_or_create_pool(self, pool_entry, chance, description, flags, max_limit, is_master=False, master_pool=None):
