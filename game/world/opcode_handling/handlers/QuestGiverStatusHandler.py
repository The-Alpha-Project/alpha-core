...
class QuestGiverStatusHandler(object):
    ...
    def handle(world_session, socket, reader):
        if len(reader.data) >= 8:  # Avoid handling empty set selection packet
            ...
            #   Get the quest status, lets assume for now it is a unit. TODO: Dynat: Handle game object situations
            ...
            #   TODO: Dynat: If unit is hostile to player, do not display status
    ...
    #   TODO: Dynat: Create seperate handler files for all of the below
