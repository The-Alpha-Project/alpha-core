...
class UnitStats(IntEnum):
    ...
    DAMAGE_DONE = 21
    DAMAGE_DONE_SCHOOL = 22
    DAMAGE_DONE_WEAPON = 23
    DAMAGE_DONE_CREATURE_TYPE = 24
    DAMAGE_TAKEN = 25
    DAMAGE_TAKEN_SCHOOL = 26

    HEALTH_REGENERATION_PER_5 = 27
    POWER_REGENERATION_PER_5 = 28

    ATTACK_SPEED = 29
    THREAT = 30
    STEALTH = 31
    STEALTH_DETECTION = 32
    INVISIBILITY = 33
    INVISIBILITY_DETECTION = 34
    SPEED_WALK = 35
    SPEED_MOUNTED = 36
