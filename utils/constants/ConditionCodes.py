...
class ConditionTargetsInternal(IntEnum):
    CONDITION_REQ_NONE = 0
    CONDITION_REQ_TARGET_UNIT = 1
    CONDITION_REQ_TARGET_PLAYER = 2
    CONDITION_REQ_ANY_WORLDOBJECT = 3
    CONDITION_REQ_SOURCE_UNIT = 4
    CONDITION_REQ_SOURCE_WORLDOBJECT = 5
    CONDITION_REQ_MAP_OR_WORLDOBJECT = 6
    CONDITION_REQ_TARGET_WORLDOBJECT = 7
    CONDITION_REQ_SOURCE_CREATURE = 8
    CONDITION_REQ_BOTH_WORLDOBJECTS = 9
    CONDITION_REQ_TARGET_GAMEOBJECT = 10
