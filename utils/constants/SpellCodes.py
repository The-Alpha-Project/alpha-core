...
class SpellEffects(IntEnum):
    ...
    # SPELL_EFFECT_WEAPON_PERC_DMG = 0x1F # Dismember - Not used.
...
class ShapeshiftFlags(IntEnum):
    ...
    SHAPESHIFT_FLAG_BLB_PLAYER = 0x800  # Unused in 0.5.3
...
#    SPELL_AURA_PERIODIC_HEALTH_FUNNEL = 62
    SPELL_AURA_PERIODIC_MANA_FUNNEL = 63 # zzOLDMana Funnel
