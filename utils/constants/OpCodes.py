...
class OpCode(IntEnum):
    ...
    SMSG_QUESTGIVER_STATUS = 0x017F             # CGPlayer_C::OnQuestGiverStatus
    CMSG_QUESTGIVER_HELLO = 0x0180
    SMSG_QUESTGIVER_QUEST_LIST = 0x0181         # CGPlayer_C::OnQuestGiverListQuests
    CMSG_QUESTGIVER_QUERY_QUEST = 0x0182
    CMSG_QUESTGIVER_QUEST_AUTOLAUNCH = 0x0183
    SMSG_QUESTGIVER_QUEST_DETAILS = 0x0184      # CGPlayer_C::OnQuestGiverSendQuest
    CMSG_QUESTGIVER_ACCEPT_QUEST = 0x0185
    CMSG_QUESTGIVER_COMPLETE_QUEST = 0x0186
    SMSG_QUESTGIVER_REQUEST_ITEMS = 0x0187      # CGPlayer_C::OnQuestGiverRequestItems
    CMSG_QUESTGIVER_REQUEST_REWARD = 0x0188
    SMSG_QUESTGIVER_OFFER_REWARD = 0x0189       # CGPlayer_C::OnQuestGiverChooseReward
    CMSG_QUESTGIVER_CHOOSE_REWARD = 0x018A
    SMSG_QUESTGIVER_QUEST_INVALID = 0x018B      # CGPlayer_C::OnQuestGiverInvalidQuest
    CMSG_QUESTGIVER_CANCEL = 0x018C
    SMSG_QUESTGIVER_QUEST_COMPLETE = 0x018D     # CGPlayer_C::OnQuestGiverQuestComplete
    SMSG_QUESTGIVER_QUEST_FAILED = 0x018E       # CGPlayer_C::OnQuestGiverQuestFailed
    CMSG_QUESTLOG_SWAP_QUEST = 0x018F
    CMSG_QUESTLOG_REMOVE_QUEST = 0x0190
    SMSG_QUESTLOG_FULL = 0x0191                 # CGGameUI::DisplayError(GERR_QUEST_LOG_FULL);
